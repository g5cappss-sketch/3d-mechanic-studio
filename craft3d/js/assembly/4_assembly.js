...
function spawnStandalonePin() {
  ...
  part.addSocket({ id: 'pin_top', type: 'male', radius: pinRadius, pos: [0, pinLength / 2, 0], axis: [0, 1, 0] });
  part.addSocket({ id: 'pin_bottom', type: 'male', radius: pinRadius, pos: [0, -pinLength / 2, 0], axis: [0, -1, 0] });
  selectPart(part.id);
  return part;
}
